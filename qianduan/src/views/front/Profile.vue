...
const getFollowingList = async () => {
  ...
  dialogTitle.value = 'Following List'
  dialogVisible.value = true
  try {
    const res = await request.get('/userFollow/floowList')
    if (res.data.code === 200) {
      userList.value = res.data.data
    }
  } catch (error) {
    ElMessage.error('Failed to get following list')
  } finally {
...
const getFansList = async () => {
  dialogLoading.value = true
  dialogTitle.value = 'Followers List'
  dialogVisible.value = true
  try {
    const res = await request.get('/userFollow/fansList')
    if (res.data.code === 200) {
      userList.value = res.data.data
    }
  } catch (error) {
    ElMessage.error('Failed to get followers list')
  } finally {
    dialogLoading.value = false
  }
}
...
<template>
  <div class="profile-container">
          ...
          <div class="profile-content">
            ...
            <div class="left-section">
              ...
              <div class="stats-grid">
                <div class="stat-card" @click="router.push('/front/MyPost')">
                ...
                <div class="stat-card" @click="router.push('/front/MyReply')">
                ...
                <div class="stat-card" @click="getFansList">
                ...
                <div class="stat-card" @click="getFollowingList">
    ...
    <el-dialog
      ...
      destroy-on-close
    >
      <el-skeleton :loading="dialogLoading" animated :rows="3">
        <template #default>
          <div class="user-list">
            <div v-for="user in userList" :key="user.id" class="user-item">
              <div class="user-info">
                ...
                <div class="user-details">
                  ...
                  <div class="user-bio">{{ user.bio || 'No introduction yet' }}</div>
                </div>
              </div>
              <div class="user-stats">
                <div class="stat">
                  <div class="value">{{ user.postCount }}</div>
                  <div class="label">Posts</div>
                </div>
                <div class="stat">
                  <div class="value">{{ user.followerCount }}</div>
